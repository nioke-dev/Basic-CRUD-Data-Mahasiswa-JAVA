...
public class data extends javax.swing.JFrame {
    ...
    private void datatable(){
        ...
        try {
            ...
            ResultSet res = statement.executeQuery("Select * from data_mahasiswa");
            while (res.next()) {                
...
//            JOptionPane.showMessageDialog(rootPane, "Gagal");
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        try {
            Statement statement = (Statement)konek.getConnection().createStatement();
            statement.executeUpdate("insert into data_mahasiswa VALUES ('" + npm + "','" + nama + "','" + kelas + "','" + jk + "','" + alamat + "');");                        
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        if (bedit.getText() == "bedit") {
            ...
            try {
                ...
                statement.executeUpdate("update data_mahasiswa SET nama='" + nama + "',"+"kelas='" + kelas + "',"+"jk='" + jk + "',"+"alamat='" + alamat  + "' WHERE npm = '"+npm+"'");
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        // TODO add your handling code here:
         ...
         try {
                Statement statement = (Statement)konek.getConnection().createStatement();
                statement.executeUpdate("delete from data_mahasiswa where npm ='" + npm + "' OR nama = '" + nama + "';");
    ...
    private void bcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcariActionPerformed
        ...
        try {
            Statement statement = (Statement)konek.getConnection().createStatement();
            ResultSet res  = statement.executeQuery("select * from data_mahasiswa where " + "npm like '%" + txt_cari.getText()+"%' OR "+"nama like '%" + txt_cari.getText()+"%'");
            DefaultTableModel tbl  = new DefaultTableModel();
            tbl.addColumn("NPM");
            tbl.addColumn("Nama Mahasiswa");
            tbl.addColumn("Kelas");
